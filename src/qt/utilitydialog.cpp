    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("FlatEarth Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About FlatEarth Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  flatearth-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the FlatEarth in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 FLAT, 0.1 FLAT, 1 FLAT and 10 FLAT -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("FlatEarth Core is shutting down...") + "<br /><br />" +
