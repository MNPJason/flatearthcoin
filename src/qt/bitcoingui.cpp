    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("FlatEarth Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a FlatEarth address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and flatearth: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About FlatEarth Core"), this);
    aboutAction->setStatusTip(tr("Show information about FlatEarth Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for FlatEarth Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your FlatEarth addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified FlatEarth addresses"));
    ...
    openAction->setStatusTip(tr("Open a flatearth: URI or payment request"));

    showHelpMessageAction = new QAction(QIcon(":/icons/" + theme + "/information"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the FlatEarth Core help message to get a list with possible FlatEarth Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("FlatEarth Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FlatEarth network", "", count));
    } else {
...
{
    QString strTitle = tr("FlatEarth Core"); // default title
    ...
    // Append title to "FlatEarth Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
