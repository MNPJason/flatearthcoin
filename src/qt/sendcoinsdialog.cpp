...
void SendCoinsDialog::updateGlobalFeeVariables()
{
    ...
    else
    {
        ...
        // if user has selected to set a minimum flatearth fee, pass the value to coincontrol
...
void SendCoinsDialog::coinControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel())
    {
        ...
        {
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid FlatEarth address"));
        }
        else // Valid address
        {
            CKeyID keyid;
...
void SendCoinsDialog::coinControlUpdateLabels()
{
    ...
    {
        // enable minimum flatearth fee UI controls
    ...
    {
        // in case coin control is disabled (=default), hide minimum flatearth fee UI controls
