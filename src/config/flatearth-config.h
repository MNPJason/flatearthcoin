...
#define PACKAGE_BUGREPORT "https://github.com/flatearthcrypto/flatearthcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "FlatEarth Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "FlatEarth Core 0.12.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "flatearthcore"
