...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("FlatEarth Core flatearth-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  flatearth-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded flatearth transaction") + "\n" +
              "  flatearth-tx [options] -create [commands]   " + _("Create hex-encoded flatearth transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded flatearth transaction
