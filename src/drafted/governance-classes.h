 ...
 *
 *   // network
 *   CFlatEarthNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CFlatEarthNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CFlatEarthNetwork(UniValue objIn)
    {
...
// // can be under: FlatEarthNetwork
// //   -- signature requirements : Key1(User)
// class CFlatEarthNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == FlatEarthNetwork);
//     // }
