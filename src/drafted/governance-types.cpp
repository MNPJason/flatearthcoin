...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "FlatEarthNetwork") type = FlatEarthNetwork;
    if(strType == "FlatEarthNetworkVariable") type = FlatEarthNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == FlatEarthNetwork) s = "FlatEarthNetwork";
    if(type == FlatEarthNetworkVariable) s = "FlatEarthNetworkVariable";
