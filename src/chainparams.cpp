...
{
    const char* pszTimestamp = "FlatEarth is up and running on 04 05 2018";
    const CScript genesisOutputScript = CScript() << ParseHex("0474f442759ab0f44e4be51232345456b477388a830201131ac883bfadb4ab5852aa32373678c5b501f4742f365ffd8494d69d15fd805a4e0e6ffc4706106d99b8") << OP_CHECKSIG;                                                                
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan     =  60 * 60 * 24; // FlatEarth: 1 day
        consensus.nPowTargetSpacing =  120; // FlatEarth: 2 min
        ...
        genesis = CreateGenesisBlock(1518598800, 2990920, 0x1e0ffff0, 1, 30 * COIN);
        
        consensus.hashGenesisBlock = genesis.GetHash();
        
      //  MineGenesisBlock(genesis, strNetworkID);
              
        assert(consensus.hashGenesisBlock == uint256S("0x00000d5c3a1bcf40043fcb2759d2dd305238da72f84769b365b21360ad6d782a"));
        assert(genesis.hashMerkleRoot == uint256S("0x5e3f755377656a846a23fb482a4cb2f8826501285236bd13407cd8ecdd88c9f8"));
        
        vSeeds.push_back(CDNSSeedData("s1.flatearth.ch", "s1.flatearth.ch"));
        vSeeds.push_back(CDNSSeedData("s2.flatearth.ch", "s2.flatearth.ch"));
        vSeeds.push_back(CDNSSeedData("s3.flatearth.ch", "s3.flatearth.ch"));

        // FlatEarth addresses start with 'A'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,23);
        // FlatEarth script addresses start with 's'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,125);
        // FlatEarth private keys start with 'm'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,110);
        // FlatEarth BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // FlatEarth BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // FlatEarth BIP44 coin type is '5'
        nExtCoinType = 5;
...
public:
    CTestNetParams() {
        ...
        consensus.BIP34Hash = uint256S("0x0000e58bb5b736b3a33ae8666fa2d63e036fb42e56eb5b6e5ebcf3bb73dd4e6");
        consensus.powLimit = uint256S("00000fffff000000000000000000000000000000000000000000000000000000");
        consensus.nPowTargetTimespan     =  60; // FlatEarth: 1 min
        consensus.nPowTargetSpacing =  120; // FlatEarth: 120 sec
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        consensus.nPowDGWHeight = 10;   //Dark Grav Wave block count recal coinstew
        consensus.nRuleChangeActivationThreshold = 1512; // 75% for testchains
   ...
   //     assert(consensus.hashGenesisBlock == uint256S("0x00000f15268a9b333a6c22663b3b1d9d86c3c0cd419305d4857db36b6f2746c2"));             
    //    assert(genesis.hashMerkleRoot == uint256S("0x1dffb37f00fad6dd16f05510d113ac22788b546dc04b6553eb2a5399f623e214"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("ts1.flatearth.ch", "ts1.flatearth.ch"));
        vSeeds.push_back(CDNSSeedData("ts2.flatearth.ch", "ts2.flatearth.ch"));
        vSeeds.push_back(CDNSSeedData("ts3.flatearth.ch", "ts3.flatearth.ch"));

        // Testnet FlatEarth addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Testnet FlatEarth script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet FlatEarth BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet FlatEarth BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet FlatEarth BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
...
public:
    CRegTestParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // FlatEarth: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // FlatEarth: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
      //  MineGenesisBlock(genesis, strNetworkID);
 //coinstew       assert(consensus.hashGenesisBlock == uint256S("0xc33dbd3603581b4cd9065315d9742528a7a0083ad08d3c4f33af404826cfb689"));
 //coinstew       assert(genesis.hashMerkleRoot == uint256S("0x8b377c1c53e941fa9bb77eb87265de1905d6dc8180e90eb81c54f6d51053888f"));
        ...
        // Regtest FlatEarth addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest FlatEarth script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest FlatEarth BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest FlatEarth BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest FlatEarth BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
   }
};
