...
const static CAmount FLATENT = -2;
...
const static auto FLATENT_FLAGS = {NO_ENTRY};

void SetCoinsValue(CAmount value, Coin& coin)
{
    assert(value != FLATENT);
    coin.Clear();
    assert(coin.IsSpent());
    if (value != PRUNED) {
...
public:
    ...
    {
        WriteCoinsViewEntry(base, base_value, base_value == FLATENT ? NO_ENTRY : DIRTY);
...
BOOST_AUTO_TEST_CASE(ccoins_access)
{
     ...
     */
    CheckAccessCoin(FLATENT, FLATENT, FLATENT, NO_ENTRY   , NO_ENTRY   );
    CheckAccessCoin(FLATENT, PRUNED, PRUNED, 0          , 0          );
    CheckAccessCoin(FLATENT, PRUNED, PRUNED, FRESH      , FRESH      );
    CheckAccessCoin(FLATENT, PRUNED, PRUNED, DIRTY      , DIRTY      );
    CheckAccessCoin(FLATENT, PRUNED, PRUNED, DIRTY|FRESH, DIRTY|FRESH);
    CheckAccessCoin(FLATENT, VALUE2, VALUE2, 0          , 0          );
    CheckAccessCoin(FLATENT, VALUE2, VALUE2, FRESH      , FRESH      );
    CheckAccessCoin(FLATENT, VALUE2, VALUE2, DIRTY      , DIRTY      );
    CheckAccessCoin(FLATENT, VALUE2, VALUE2, DIRTY|FRESH, DIRTY|FRESH);
    CheckAccessCoin(PRUNED, FLATENT, FLATENT, NO_ENTRY   , NO_ENTRY   );
    ...
    CheckAccessCoin(VALUE1, FLATENT, VALUE1, NO_ENTRY   , 0          );
...
BOOST_AUTO_TEST_CASE(ccoins_spend)
{
     ...
     *              Value   Value   Value   Flags        Flags
     */
    CheckSpendCoins(FLATENT, FLATENT, FLATENT, NO_ENTRY   , NO_ENTRY   );
    CheckSpendCoins(FLATENT, PRUNED, PRUNED, 0          , DIRTY      );
    CheckSpendCoins(FLATENT, PRUNED, FLATENT, FRESH      , NO_ENTRY   );
    CheckSpendCoins(FLATENT, PRUNED, PRUNED, DIRTY      , DIRTY      );
    CheckSpendCoins(FLATENT, PRUNED, FLATENT, DIRTY|FRESH, NO_ENTRY   );
    CheckSpendCoins(FLATENT, VALUE2, PRUNED, 0          , DIRTY      );
    CheckSpendCoins(FLATENT, VALUE2, FLATENT, FRESH      , NO_ENTRY   );
    CheckSpendCoins(FLATENT, VALUE2, PRUNED, DIRTY      , DIRTY      );
    CheckSpendCoins(FLATENT, VALUE2, FLATENT, DIRTY|FRESH, NO_ENTRY   );
    CheckSpendCoins(PRUNED, FLATENT, FLATENT, NO_ENTRY   , NO_ENTRY   );
    CheckSpendCoins(PRUNED, PRUNED, PRUNED, 0          , DIRTY      );
    CheckSpendCoins(PRUNED, PRUNED, FLATENT, FRESH      , NO_ENTRY   );
    CheckSpendCoins(PRUNED, PRUNED, PRUNED, DIRTY      , DIRTY      );
    CheckSpendCoins(PRUNED, PRUNED, FLATENT, DIRTY|FRESH, NO_ENTRY   );
    CheckSpendCoins(PRUNED, VALUE2, PRUNED, 0          , DIRTY      );
    CheckSpendCoins(PRUNED, VALUE2, FLATENT, FRESH      , NO_ENTRY   );
    CheckSpendCoins(PRUNED, VALUE2, PRUNED, DIRTY      , DIRTY      );
    CheckSpendCoins(PRUNED, VALUE2, FLATENT, DIRTY|FRESH, NO_ENTRY   );
    CheckSpendCoins(VALUE1, FLATENT, PRUNED, NO_ENTRY   , DIRTY      );
    CheckSpendCoins(VALUE1, PRUNED, PRUNED, 0          , DIRTY      );
    CheckSpendCoins(VALUE1, PRUNED, FLATENT, FRESH      , NO_ENTRY   );
    CheckSpendCoins(VALUE1, PRUNED, PRUNED, DIRTY      , DIRTY      );
    CheckSpendCoins(VALUE1, PRUNED, FLATENT, DIRTY|FRESH, NO_ENTRY   );
    CheckSpendCoins(VALUE1, VALUE2, PRUNED, 0          , DIRTY      );
    CheckSpendCoins(VALUE1, VALUE2, FLATENT, FRESH      , NO_ENTRY   );
    CheckSpendCoins(VALUE1, VALUE2, PRUNED, DIRTY      , DIRTY      );
    CheckSpendCoins(VALUE1, VALUE2, FLATENT, DIRTY|FRESH, NO_ENTRY   );
}
...
{
    for (CAmount base_value : {FLATENT, PRUNED, VALUE1})
...
BOOST_AUTO_TEST_CASE(ccoins_add)
{
     ...
     *           Value   Value   Value   Flags        Flags
     */
    CheckAddCoin(FLATENT, VALUE3, VALUE3, NO_ENTRY   , DIRTY|FRESH, false);
    CheckAddCoin(FLATENT, VALUE3, VALUE3, NO_ENTRY   , DIRTY      , true );
...
{
    SingleEntryCacheTest test(FLATENT, parent_value, parent_flags);
...
BOOST_AUTO_TEST_CASE(ccoins_write)
{
     ...
     */
    CheckWriteCoins(FLATENT, FLATENT, FLATENT, NO_ENTRY   , NO_ENTRY   , NO_ENTRY   );
    CheckWriteCoins(FLATENT, PRUNED, PRUNED, NO_ENTRY   , DIRTY      , DIRTY      );
    CheckWriteCoins(FLATENT, PRUNED, FLATENT, NO_ENTRY   , DIRTY|FRESH, NO_ENTRY   );
    CheckWriteCoins(FLATENT, VALUE2, VALUE2, NO_ENTRY   , DIRTY      , DIRTY      );
    CheckWriteCoins(FLATENT, VALUE2, VALUE2, NO_ENTRY   , DIRTY|FRESH, DIRTY|FRESH);
    CheckWriteCoins(PRUNED, FLATENT, PRUNED, 0          , NO_ENTRY   , 0          );
    CheckWriteCoins(PRUNED, FLATENT, PRUNED, FRESH      , NO_ENTRY   , FRESH      );
    CheckWriteCoins(PRUNED, FLATENT, PRUNED, DIRTY      , NO_ENTRY   , DIRTY      );
    CheckWriteCoins(PRUNED, FLATENT, PRUNED, DIRTY|FRESH, NO_ENTRY   , DIRTY|FRESH);
    CheckWriteCoins(PRUNED, PRUNED, PRUNED, 0          , DIRTY      , DIRTY      );
    CheckWriteCoins(PRUNED, PRUNED, PRUNED, 0          , DIRTY|FRESH, DIRTY      );
    CheckWriteCoins(PRUNED, PRUNED, FLATENT, FRESH      , DIRTY      , NO_ENTRY   );
    CheckWriteCoins(PRUNED, PRUNED, FLATENT, FRESH      , DIRTY|FRESH, NO_ENTRY   );
    CheckWriteCoins(PRUNED, PRUNED, PRUNED, DIRTY      , DIRTY      , DIRTY      );
    CheckWriteCoins(PRUNED, PRUNED, PRUNED, DIRTY      , DIRTY|FRESH, DIRTY      );
    CheckWriteCoins(PRUNED, PRUNED, FLATENT, DIRTY|FRESH, DIRTY      , NO_ENTRY   );
    CheckWriteCoins(PRUNED, PRUNED, FLATENT, DIRTY|FRESH, DIRTY|FRESH, NO_ENTRY   );
    ...
    CheckWriteCoins(VALUE1, FLATENT, VALUE1, 0          , NO_ENTRY   , 0          );
    CheckWriteCoins(VALUE1, FLATENT, VALUE1, FRESH      , NO_ENTRY   , FRESH      );
    CheckWriteCoins(VALUE1, FLATENT, VALUE1, DIRTY      , NO_ENTRY   , DIRTY      );
    CheckWriteCoins(VALUE1, FLATENT, VALUE1, DIRTY|FRESH, NO_ENTRY   , DIRTY|FRESH);
    CheckWriteCoins(VALUE1, PRUNED, PRUNED, 0          , DIRTY      , DIRTY      );
    CheckWriteCoins(VALUE1, PRUNED, FAIL  , 0          , DIRTY|FRESH, NO_ENTRY   );
    CheckWriteCoins(VALUE1, PRUNED, FLATENT, FRESH      , DIRTY      , NO_ENTRY   );
    ...
    CheckWriteCoins(VALUE1, PRUNED, FLATENT, DIRTY|FRESH, DIRTY      , NO_ENTRY   );
    ...
    for (CAmount parent_value : {FLATENT, PRUNED, VALUE1})
        for (CAmount child_value : {FLATENT, PRUNED, VALUE2})
            for (char parent_flags : parent_value == FLATENT ? FLATENT_FLAGS : FLAGS)
                for (char child_flags : child_value == FLATENT ? FLATENT_FLAGS : CLEAN_FLAGS)
