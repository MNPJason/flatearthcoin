...
#define BOOST_TEST_MODULE FlatEarth Test Suite

#include "test_flatearth.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_flatearth_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
