...
2. run flatearthd with -printalert or -sendalert like this:
   /path/to/flatearthd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.flatearthcrypto.com";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/FlatEarth Core:0.12.0.58/"));
