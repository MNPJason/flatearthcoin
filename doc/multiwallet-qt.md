...
Only requiring some minor changes is flatearth.cpp.
...
Changes to flatearth.cpp
----------------------
flatearth.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
